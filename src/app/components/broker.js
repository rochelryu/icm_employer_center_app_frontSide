        ...
        <div className="row justify-content-center">
            <div className="col">
                <div className="section-title text-center mb-4 pb-2">
                    <h4 className="title mb-3">Nos experts</h4>
                    <p className="text-muted para-desc mb-0 mx-auto">Nous sommes une équipe qualifié dans le domaine avec plus de 15 ans d&apos;expertise.</p>
                </div>
            </div>
        </div>
                    ...
                    <div className="col-lg-3 col-md-4 col-12" key={index}>
                        <div className="card team team-primary text-center">
                            <div className="card-img team-image d-inline-block mx-auto rounded-pill avatar avatar-ex-large overflow-hidden">
                                <Image src={item.image} width={0} height={0} sizes="100vw" style={{width:'100%', height:200}} alt=""/>
